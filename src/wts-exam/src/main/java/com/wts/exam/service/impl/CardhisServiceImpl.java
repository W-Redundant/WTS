...
public class CardhisServiceImpl implements CardHisServiceInter {
	...
	private static final Logger log = Logger
			.getLogger(CardhisServiceImpl.class);
	...
	public void backup(String roomid, LoginUser currentUser) throws Exception {
		...
		for (Card card : cards) {
			...
			cardhis.setRoomname(roomDaoImpl.getEntity(cardhis.getRoomid())
					.getName());
	...
	public void deleteCardhis(String cardhisid, LoginUser currentUser) {
		cardanswerhisDaoImpl.deleteEntitys(DBRuleList.getInstance()
				.add(new DBRule("CARDID", cardhisid, "=")).toList());
		cardpointhisDaoImpl.deleteEntitys(DBRuleList.getInstance()
				.add(new DBRule("CARDID", cardhisid, "=")).toList());
