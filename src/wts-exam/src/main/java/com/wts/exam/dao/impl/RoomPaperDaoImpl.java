 ...
 */
@Repository
public class RoomPaperDaoImpl extends HibernateSQLTools<RoomPaper> implements
		RoomPaperDaoInter {
	...
	public String getPaperAliasByCardId(String cardId) {
		Session session = sessionFatory.getCurrentSession();
		SQLQuery sqlquery = session
				.createSQLQuery("select NAME from WTS_CARD a left join WTS_ROOM_PAPER b on a.ROOMID=b.ROOMID and a.PAPERID=b.PAPERID where a.id=?");
