...
public class ExamStatController extends WebUtils {
	private final static Logger log = Logger
			.getLogger(ExamStatController.class);
	@Resource
	...
	public Map<String, Object> queryall(DataQuery query,
		...
		try {
			...
			DataResult result = examStatServiceImpl.createExamstatSimpleQuery(
					query).search();
	...
	public ModelAndView index(HttpSession session) {
		return ViewMode.getInstance().returnModelAndView("exam/ExamstatResult");
	}
		...
		try {
			...
			case (0): {// 查看
				return ViewMode
						...
						.putAttr("entity",
								examStatServiceImpl.getExamstatEntity(ids))
