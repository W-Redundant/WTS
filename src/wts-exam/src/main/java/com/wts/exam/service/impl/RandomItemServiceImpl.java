...
public class RandomItemServiceImpl implements RandomItemServiceInter {
	...
	private static final Logger log = Logger
			.getLogger(RandomItemServiceImpl.class);
	...
	public List<RandomItem> getLiveRandomItems() {
		return randomitemDaoImpl.selectEntitys(DBRuleList.getInstance()
	...
	public List<RandomStep> getSteps(String itemid) {
		return randomstepDaoImpl.selectEntitys(DBRuleList.getInstance()
				.add(new DBRule("ITEMID", itemid, "=")).toList());
	}
