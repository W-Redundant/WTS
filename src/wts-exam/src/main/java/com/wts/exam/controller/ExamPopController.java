...
public class ExamPopController extends WebUtils {
	...
	public Map<String, Object> queryall(String functype, String typeids,
		...
		try {
			...
			DataResult result = examPopsServiceImpl.createExampopSimpleQuery(
					query).search();
	...
	public Map<String, Object> editSubmit(ExamPop entity, HttpSession session) {
		...
		try {
			entity = examPopsServiceImpl.editExampopEntity(entity,
	...
	public Map<String, Object> addSubmit(String userids, String functype,
		...
		try {
			...
			examPopsServiceImpl.insertPop(userIds, typeIds, functype,
					getCurrentUser(session));
	...
	public Map<String, Object> delSubmit(String ids, HttpSession session) {
		try {
			for (String id : parseIds(ids)) {
				examPopsServiceImpl.deleteExampopEntity(id,
						getCurrentUser(session));
			}
		...
		try {
			...
			case (0): {// 查看
				return ViewMode
						...
						.putAttr("entity",
								examPopsServiceImpl.getExampopEntity(ids))
