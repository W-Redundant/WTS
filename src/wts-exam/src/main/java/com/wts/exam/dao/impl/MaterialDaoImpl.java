 ...
 */
@Repository
public class MaterialDaoImpl extends HibernateSQLTools<Material> implements
		MaterialDaoInter {
	...
	public String getIdByUuid(String uuid) {
		Session session = sessionFatory.getCurrentSession();
		SQLQuery sqlquery = session
				.createSQLQuery("select ID from WTS_MATERIAL where uuid=?");
