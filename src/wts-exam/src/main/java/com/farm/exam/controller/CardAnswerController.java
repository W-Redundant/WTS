...
import com.farm.exam.service.CardAnswerServiceInter;
...
public class CardAnswerController extends WebUtils {
	private final static Logger log = Logger
			.getLogger(CardAnswerController.class);
	@Autowired
		...
		try {
			...
			case (0): {// 查看
				return ViewMode
						...
						.putAttr("entity",
								cardAnswerServiceImpl.getCardAnswerEntity(ids))
