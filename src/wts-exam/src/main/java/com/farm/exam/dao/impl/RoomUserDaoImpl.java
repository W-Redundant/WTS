 ...
 */
@Repository
public class RoomUserDaoImpl extends HibernateSQLTools<RoomUser> implements
		RoomUserDaoInter {
	@Autowired
	...
	public List<Map<String, Object>> getRoomUsers(String roomid) {
		...
		Session session = sessionFatory.getCurrentSession();
		SQLQuery sqlquery = session
				.createSQLQuery("SELECT a.ID AS ROOMID, a. NAME AS ROOMNAME, b.USERID AS USERID, c. NAME AS USERNAME, e.ID AS orgid, e. NAME AS ORGNAME "
