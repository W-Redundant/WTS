...
public class PaperExportController extends WebUtils {
	private final static Logger log = Logger
			.getLogger(PaperExportController.class);
	@Autowired
	...
	public static String getThemePath() {
		return FarmParameterService.getInstance().getParameter(
				"config.sys.web.themes.path");
	}
	...
	public void loadimg(String paperid, String roomid,
		...
		WcpLog.info("导出答卷" + paperid + "/" + paper.getInfo().getName(),
