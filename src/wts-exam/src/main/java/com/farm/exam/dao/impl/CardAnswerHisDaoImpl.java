...
import com.farm.exam.dao.CardAnswerHisDaoInter;
 ...
 */
@Repository
public class CardAnswerHisDaoImpl extends HibernateSQLTools<CardAnswerHis>
		implements CardAnswerHisDaoInter {
	@Autowired
	...
	public CardAnswerHis getEntity(String cardanswerhisid) {
		// TODO 自动生成代码,修改后请去除本注释
		Session session = sessionFatory.getCurrentSession();
		return (CardAnswerHis) session
				.get(CardAnswerHis.class, cardanswerhisid);
	}
