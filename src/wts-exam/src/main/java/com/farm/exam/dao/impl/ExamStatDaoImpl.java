...
import com.farm.exam.dao.ExamStatDaoInter;
 ...
 */
@Repository
public class ExamStatDaoImpl extends HibernateSQLTools<ExamStat> implements
		ExamStatDaoInter {
	@Autowired
	...
	public ExamStat getEntity(LoginUser user) {
		Query query = sessionFatory.getCurrentSession().createQuery(
				"from ExamStat where cuser=?");
